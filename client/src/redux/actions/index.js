...
export const registerAction = (payload) => async (dispatch) => {
  try {
    ...
    notification(
      "Your account was created succesfully, You can now login",
      "success",
      dispatch,
      enqueueSnackbar,
      closeSnackbar
...
export const fetchTweets = (query, page, next, isFirst) => async (dispatch) => {
  try {
    ...
    if (next === null) dispatch({ type: "GET_TWEETS", payload: data });
    else {
