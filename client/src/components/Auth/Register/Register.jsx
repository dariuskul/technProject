...
const Register = () => {
  ...
  const RegisterSchema = Yup.object().shape({
    username: Yup.string().min(5,'At least 5 characters').required('Username cannot be empty!'),
    password: Yup.string().min(6,'Password must be with at least 6 characters').required('Please provide password!'),
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={12}>
              <TextField
                ...
                helperText={form.errors.dateOfBirth ? form.errors.dateOfBirth : ''}
              />
            </Grid>
          </Grid>
